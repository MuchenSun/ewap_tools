...
for frame in tqdm(full_frame_list):
    os.rename("./ewap_dataset/seq_eth/img_rename/eth_parallel_frame{0:08}.png".format(frame), "./ewap_dataset/seq_eth/img_rename/eth_parallel_frame{0:08}.png".format(file_idx))
    file_idx += 1
